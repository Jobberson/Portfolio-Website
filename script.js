(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btn) {
      // FIX #8: Removed unused `currentTheme` variable.
      // The initial aria-pressed state is derived directly from the DOM attribute,
      // which was already set by the inline FOUC-prevention script in <head>.
    ...
    // -------------------------------------------------------
    // Footer year (overwrites static fallback)
    // -------------------------------------------------------
    ...
    // -------------------------------------------------------
    // Nav active state via aria-current (section IntersectionObserver)
    // -------------------------------------------------------
    ...
    function setActiveLink(id) {
      ...
      if (sectionMap[id]) { sectionMap[id].link.setAttribute('aria-current', 'page'); }
    }
    ...
    // -------------------------------------------------------
    // Safety net: ensure target=_blank links have rel="noopener noreferrer"
    // -------------------------------------------------------
